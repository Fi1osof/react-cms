...
export default class HallDecorationRenderer extends Renderer{
  ...
  getTitle(title){
    ...
    return super.getTitle("Оформление зала");
  }
      ...
      >
        {editable
          ...
          <div
            className="hint"
          >
            Здесь написать про оформление зала
          </div>
          :
          null
        }
