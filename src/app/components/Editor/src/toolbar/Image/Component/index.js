...
// import icon from '../styles/image.svg';
import Icon from "material-ui-icons/Photo";

export default class ImageLayoutComponent extends Component {
  ...
  renderAddImageModal(): Object {
    ...
    translations['generic.add'] = "Вставить";
    translations['generic.cancel'] = "Отмена";
